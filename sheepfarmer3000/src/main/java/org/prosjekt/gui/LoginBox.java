...
/**
 * Klasse som lager Login-vinduet til GUI, dette vinduet gjør det mulig for å
 * brukeren å logge seg inn i programmet
 *
...
public class LoginBox extends JFrame implements ActionListener {
    ...
    /**
     * Konstruktør, fyller login-vinduet med alle GUI-elementer og vinduet
     */
    public LoginBox() {
    ...
    /**
     * Metode som brukes for å lukke dette vinduet
     */

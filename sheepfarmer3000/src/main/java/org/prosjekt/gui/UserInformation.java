...
/**
 * Klasse som lager User Inforamtion vinduet i GUI, og fyller dette med
...
public class UserInformation extends JFrame implements ActionListener {
    ...
    /**
     * Konstruktør, åpner user information-vinduet med informasjon om brukeren i
     * parameteret
     *
     * @param f Farmer-objekt som denne klassen henter informasjonen som vises i
     * vinduet fra
     */
    ...
    /**
     * Metode som lager øverste nivå GUI-elementer til dette vinduet, og kaller
     * metoder som lager lavere nivås GUI-elementer
     */
    ...
    /**
     * Metode som lager et JPanel som inneholder overskriften til dette vinduet
     *
    ...
    /**
     * Metode som lager et JPanel som inneholder alle GUI-elementene som
     * brukeren kan aksessere i dette vinduet, kaller metoder som lager de
     * individuelle GUI-elementene
     *
     * @return JPanel som inneholder alle GUI-elementene brukeren kan aksesserer
     */
    ...
    /**
     * Metode som lager et JPanel som inneholder GUI-elementene for
     * brukerinformasjon på venstre delen av vinduet
     *
     * @return JPanel med GUI-elementer
     */
    ...
    /**
     * Metode som lager et JPanel som inneholder GUI-elementene for
     * brukerinformasjon på den høyre delen av vinduet
     *
     * @return JPanel med GUI-elementer
     */
    ...
    /**
     * Metode som lager et JPanel som inneholder GUI-elementene for endring av
     * passord på venstre del av vinduet
     *
     * @return JPanel med GUI-elementer
     */
    ...
    /**
     * Metode som lager et JPanel som inneholder GUI-elementene for endring av
     * passord på høyre del av vinduet
     *
     * @return JPanel med GUI-elementer
     */
    ...
    /**
     * Metode som lager et JPanel bestående av knappene til dette vinduet
     * @return JPanel med GUI-elementer
     */
    ...
    /**
     * Metode som lagrer endringer brukeren har gjort i dette vinduet
     * @return boolean med informasjon om endringer var vellykket
     */
    ...
    /**
     * Metode som tester om passordene brukeren har skrevet overens er gyldige
     * @return boolean med informasjon om passordene brukeren har skrevet er gyldige
     */
